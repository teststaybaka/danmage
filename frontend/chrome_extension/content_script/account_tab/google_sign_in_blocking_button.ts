...
export class GoogleSignInBlockingButton extends BlockingButton {
  ...
  public constructor() {
    super(
      `${NULLIFIED_BUTTON_STYLE} display: flex; flex-flow: row nowrap; align-items: center; cursor: pointer;`,
    );
    this.append(
      createGoogleIcon(),
      E.div(
        {
          ...
          style: `font-family: initial !important; padding: 0 8px; font-size: ${FONT_M}px; color: ${GOOGLE_BUTTON_TEXT_COLOR};`,
        },
