...
export let BUTTON_BORDER_RADIUS = `.25rem`;
...
export let COMMON_BUTTON_STYLE = `${NULLIFIED_BUTTON_STYLE} flex: 0 0 auto; font-family: initial !important; font-size: ${FONT_M}rem; line-height: 100%; border-radius: ${BUTTON_BORDER_RADIUS}; padding: .5rem .75rem; border: .0625rem solid transparent; cursor: pointer;`
